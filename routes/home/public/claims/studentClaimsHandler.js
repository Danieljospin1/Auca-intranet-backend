...
router.get('/categories', Authenticate, async (req, res) => {
    ...
    try {
        const [claimCategories] = await connectionPromise.query(`select cc.CategoryId, cc.CategoryName, count(*) as NumberOfClaims from claims c join claimCategory cc on c.CategoryId = cc.CategoryId where c.PostId=? group by c.CategoryId, cc.CategoryName,`, [PostId]);
